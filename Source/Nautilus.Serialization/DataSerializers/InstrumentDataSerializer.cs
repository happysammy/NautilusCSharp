        ...
        public Instrument Deserialize(byte[] dataBytes)
        {
            ...
            if (securityType == SecurityType.Forex)
            {
                return new ForexInstrument(
                    ...
                    (ushort)unpacked[nameof(Instrument.PricePrecision)].AsInt32,
                    (ushort)unpacked[nameof(Instrument.SizePrecision)].AsInt32,
                    (ushort)unpacked[nameof(Instrument.MinStopDistanceEntry)].AsInt32,
                    (ushort)unpacked[nameof(Instrument.MinLimitDistanceEntry)].AsInt32,
                    (ushort)unpacked[nameof(Instrument.MinStopDistance)].AsInt32,
                    (ushort)unpacked[nameof(Instrument.MinLimitDistance)].AsInt32,
