...
namespace Nautilus.TestSuite.UnitTests.CoreTests.CorrectnessTests
{
    ...
    public sealed class DebugTests
    {
        ...
        internal void HasAttribute_WhenDoesHaveAttribute_DoesNothing()
        {
            ...
            // Act
            // Assert
            Debug.HasAttribute<DataContractAttribute>(typeof(TestClass), nameof(TestClass));
        ...
        internal void HasAttribute_WhenDoesNotHaveAttribute_Throws()
        {
            ...
            // Act
            // Assert
            Assert.Throws<ArgumentException>(() => Debug.HasAttribute<DataMemberAttribute>(typeof(TestClass), nameof(TestClass)));
        }
