...
namespace Nautilus.TestSuite.UnitTests.CoreTests.ValidationTests
{
    ...
    public class DebugTests
    {
        ...
        internal void PositiveInt32_VariousNotPositiveValues_Throws(int value)
        {
            ...
            // Act
            // Assert
            Assert.Throws<ValidationException>(() => Debug.PositiveInt32(value, nameof(value)));
        }
        ...
        internal void NotNegativeInt32_VariousNegativeValues_Throws(int value)
        {
            ...
            // Act
            // Assert
            Assert.Throws<ValidationException>(() => Debug.NotNegativeInt32(value, nameof(value)));
        }
        ...
        internal void PositiveInt64_VariousNotPositiveValues_Throws(long value)
        {
            ...
            // Act
            // Assert
            Assert.Throws<ValidationException>(() => Debug.PositiveInt64(value, nameof(value)));
        }
        ...
        internal void NotNegativeInt64_VariousNegativeValues_Throws(long value)
        {
            ...
            // Act
            // Assert
            Assert.Throws<ValidationException>(() => Debug.NotNegativeInt64(value, nameof(value)));
        }
        ...
        internal void PositiveDouble_VariousNotPositiveValues_Throws(double value)
        {
            ...
            // Act
            // Assert
            Assert.Throws<ValidationException>(() => Debug.PositiveDouble(value, nameof(value)));
        }
        ...
        internal void NotNegativeDouble_VariousNegativeValues_Throws(double value)
        {
            ...
            // Act
            // Assert
            Assert.Throws<ValidationException>(() => Debug.NotNegativeDouble(value, nameof(value)));
        }
        ...
        internal void PositiveDecimal_VariousNotPositiveValues_Throws(decimal value)
        {
            ...
            // Act
            // Assert
            Assert.Throws<ValidationException>(() => Debug.PositiveDecimal(value, nameof(value)));
        }
        ...
        internal void NotNegativeDecimal_VariousNegativeValues_Throws(decimal value)
        {
            ...
            // Act
            // Assert
            Assert.Throws<ValidationException>(() => Debug.NotNegativeDecimal(value, nameof(value)));
        }
