...
namespace QuickFix.UnitTests
{
    ...
    public class SessionTest
    {
        ...
        public void Logon()
        {
            SendLogon(new QuickFix.FIX44.Logon());
        }
        ...
        {
            SendTheMessage(new QuickFix.FIX44.ResendRequest(
...
//            sessionID = new QuickFix.SessionID(QuickFix.FixValues.BeginString.FIX44, "SENDER", "TARGET");
...
//            QuickFix.FIX44.SequenceReset reset = new QuickFix.FIX44.SequenceReset();
...
//
//            QuickFix.Message msg = new QuickFix.FIX44.ResendRequest(
...
//            Logon();
//
//            QuickFix.FIX44.SequenceReset sr = new QuickFix.FIX44.SequenceReset(new QuickFix.Fields.NewSeqNo(5));
...
//            QuickFix.FIX44.Reject rej = responder.msgLookup[QuickFix.Fields.MsgType.REJECT].Peek() as QuickFix.FIX44.Reject;
