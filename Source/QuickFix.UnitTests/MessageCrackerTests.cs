...
namespace QuickFix.UnitTests
{
    ...
    public class MessageCrackerTests
    {
        ...
        {
            // This is a handler.
            public void OnMessage(QuickFix.FIX44.News m, SessionID s) { }

            // These are NOT handlers because...

            // it's private
            private void OnMessage(QuickFix.FIX44.ListCancelRequest m, SessionID s) { }

            // name doesn't match convention
            public void NameIsWrong(QuickFix.FIX44.ListExecute m, SessionID s) { }

            // params count != 2
            public void OnMessage(QuickFix.FIX44.ListStatus m) { }
            public void OnMessage(QuickFix.FIX44.ListStatusRequest m, SessionID s, object o) { }

            // param types aren't correct
            public void OnMessage(object o, SessionID s) { }
            public void OnMessage(QuickFix.FIX44.ListStrikePrice m, object o) { }

            // return value isn't void
            public int OnMessage(QuickFix.FIX44.MassQuote m, SessionID s) { return 0; }
        }
        ...
        public void IsHandlerMethod()
        {
            ...
            Assert.AreEqual(handlers[0].GetParameters()[0].ParameterType, typeof(QuickFix.FIX44.News));
        }
...
//        {
//            MessageCracker mc = new TestCracker();
//            Assert.Throws<UnsupportedMessageType>(delegate { mc.Crack(new QuickFix.FIX44.Email(), _DummySessionID); });
//            Assert.Throws<UnsupportedMessageType>(delegate { mc.Crack(new QuickFix.FIX44.News(), _DummySessionID); });
//        }
    }
}
