...
namespace QuickFix.UnitTests
{
    ...
    public class GroupTests
    {
        ...
        {
            QuickFix.FIX44.News.LinesOfTextGroup linesGroup = new QuickFix.FIX44.News.LinesOfTextGroup();
            linesGroup.Text = new QuickFix.Fields.Text("foo");
            linesGroup.EncodedText = new QuickFix.Fields.EncodedText("bar");

            QuickFix.FIX44.News.LinesOfTextGroup clone = linesGroup.Clone() as QuickFix.FIX44.News.LinesOfTextGroup;
