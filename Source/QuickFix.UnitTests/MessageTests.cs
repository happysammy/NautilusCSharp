...
namespace QuickFix.UnitTests
{
    ...
    using QuickFix.UnitTests.TestHelpers;
...
//        {
//            string str1 = "8=FIX.4.4\x01" + "9=55\x01" + "35=0\x01" + "34=3\x01" + "49=TW\x01" +
//                "52=20000426-12:05:06\x01" + "56=ISLD\x01" + "1=acct123\x01" + "10=123\x01";
//            Message msg = new Message();
//            try
//            {
...
//        }
        ...
        public void AddGroupGetGroupTest()
        {
            ...
            var noTradingSessions = new QuickFix.FIX44.NewOrderSingle.NoTradingSessionsGroup();
            ...
            var nos2 = new QuickFix.FIX44.NewOrderSingle();
...
//        }
        ...
        public void MsgType()
        {
            Assert.AreEqual("B", QuickFix.FIX44.News.MsgType);
        }
        ...
        public void ExtractFieldTypes()
        {
            ...
            QuickFix.FIX44.NewOrderSingle n = new QuickFix.FIX44.NewOrderSingle();
        ...
        public void RepeatingGroup()
        {
            ...
            QuickFix.FIX44.News news = new QuickFix.FIX44.News(new QuickFix.Fields.Headline("Foo headline"));

            QuickFix.FIX44.News.LinesOfTextGroup group1 = new QuickFix.FIX44.News.LinesOfTextGroup();
            ...
            QuickFix.FIX44.News.LinesOfTextGroup group2 = new QuickFix.FIX44.News.LinesOfTextGroup();
...
//
//            string nul = "\x01";
//            string s = "8=FIX.4.4" + nul + "9=148" + nul + "35=D" + nul + "34=2" + nul + "49=TW" + nul + "52=20111011-15:06:23.103" + nul + "56=ISLD" + nul
...
//            Assert.IsInstanceOf<QuickFix.FIX44.News.LinesOfTextGroup>(grp1);
//            Assert.AreEqual("L1", (grp1 as QuickFix.FIX44.News.LinesOfTextGroup).Text.Obj);
//
//            var grp2 = msg.GetGroup(2, Tags.LinesOfText);
//            Assert.IsInstanceOf<QuickFix.FIX44.News.LinesOfTextGroup>(grp2);
//            Assert.AreEqual("L2", (grp2 as QuickFix.FIX44.News.LinesOfTextGroup).Text.Obj);
//        }
...
//
//            // the test
//            QuickFix.FIX44.News.LinesOfTextGroup grp = new QuickFix.FIX44.News.LinesOfTextGroup(); // for return value
//
//            msg.GetGroup(1, grp);
...
//        }
        ...
        public void IsAdmin_IsApp()
        {
            ...
            QuickFix.FIX44.News news = new QuickFix.FIX44.News();
            ...
            QuickFix.FIX44.Heartbeat heartbeat = new QuickFix.FIX44.Heartbeat();
