        ...
        public QueryResult<Instrument> Read(string key)
        {
            ...
            if (securityType == SecurityType.Forex)
            {
                var forexCcy = new ForexInstrument(
                    ...
                    Convert.ToUInt16(instrumentDict[nameof(Instrument.PricePrecision)]),
                    Convert.ToUInt16(instrumentDict[nameof(Instrument.SizePrecision)]),
                    Convert.ToUInt16(instrumentDict[nameof(Instrument.MinStopDistanceEntry)]),
                    Convert.ToUInt16(instrumentDict[nameof(Instrument.MinLimitDistanceEntry)]),
                    Convert.ToUInt16(instrumentDict[nameof(Instrument.MinStopDistance)]),
                    Convert.ToUInt16(instrumentDict[nameof(Instrument.MinLimitDistance)]),
        ...
        private void Write(Instrument instrument)
        {
            if (instrument is ForexInstrument forexCcy)
            {
                var forexHash = new[]
                {
                    ...
                    new HashEntry(nameof(ForexInstrument.PricePrecision), (int)forexCcy.PricePrecision),
                    new HashEntry(nameof(ForexInstrument.SizePrecision), (int)instrument.SizePrecision),
                    new HashEntry(nameof(ForexInstrument.MinStopDistanceEntry), (int)forexCcy.MinStopDistanceEntry),
                    new HashEntry(nameof(ForexInstrument.MinLimitDistanceEntry), (int)forexCcy.MinLimitDistanceEntry),
                    new HashEntry(nameof(ForexInstrument.MinStopDistance), (int)forexCcy.MinStopDistance),
                    new HashEntry(nameof(ForexInstrument.MinLimitDistance), (int)forexCcy.MinLimitDistance),
            ...
            var instrumentHash = new[]
            {
                ...
                new HashEntry(nameof(Instrument.PricePrecision), (int)instrument.PricePrecision),
                new HashEntry(nameof(Instrument.SizePrecision), (int)instrument.SizePrecision),
                new HashEntry(nameof(Instrument.MinStopDistanceEntry), (int)instrument.MinStopDistanceEntry),
                new HashEntry(nameof(Instrument.MinLimitDistanceEntry), (int)instrument.MinLimitDistanceEntry),
                new HashEntry(nameof(Instrument.MinStopDistance), (int)instrument.MinStopDistance),
                new HashEntry(nameof(Instrument.MinLimitDistance), (int)instrument.MinLimitDistance),
